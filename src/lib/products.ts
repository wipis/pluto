...
[Name]`,
      ...
      {
        context: "Recent HIPAA-related update on their website, compliance focus",
        hook: "They care deeply about compliance infrastructure",
        subject: "HIPAA-compliant record processing",
        body: `Hi Jennifer,

Saw your site update about strengthened HIPAA protocols - smart move given recent enforcement trends.

Curious if that extends to how you process medical records? A lot of firms still email PDFs around, which gets messy from a compliance standpoint.

We built File Logic as a HIPAA-compliant platform specifically for SS disability firms. All record processing happens in a secure environment with full audit trails.
